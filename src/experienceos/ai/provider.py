...
Providers only ever *propose* content. Turning a proposal into a stored
record is the caller's job and must go through user confirmation —
"AI propose, human decide" is the layer's founding constraint.
"""
